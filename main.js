...
document.addEventListener('click',function(event) {
    ...
    //演算子を連続で打てないよう制御
        if(((event.target.matches('.ope')) && (display.innerText.slice (-1) == '.ope'))){return;}
            ...
            //display.innerText =display.innerText.replace(display.innerText.slice.call(-1,0),clickNumber);
        }
